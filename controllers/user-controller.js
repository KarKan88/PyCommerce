...
const verifyEmailAddress = async(req,res) => {
    ...
    try {
        ...
        const getEmailAddress = await userModel.find({emailAddress: emailAddress})
...
const forgotPassword = async(req,res) => {
    ...
    try {
        const getUser = await userModel.find({emailAddress: emailAddress})
        if(getUser.length !==0) {
            if(getUser[0].securityQuestionOne === securityQuestionOne && getUser[0].securityQuestionTwo === securityQuestionTwo) {
